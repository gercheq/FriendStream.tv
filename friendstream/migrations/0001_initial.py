...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('friendstream_account', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('ident', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('authinfo', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2001, 1, 1, 0, 0))),
            ('last_success', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('friendstream', ['Account'])

        # Adding model 'Video'
        db.create_table('friendstream_video', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.send_create_signal('friendstream', ['Video'])

        # Adding model 'UserStream'
        db.create_table('friendstream_userstream', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendstream.Video'])),
            ('posted', self.gf('django.db.models.fields.DateTimeField')()),
            ('poster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friendstream.Account'])),
        ))
        db.send_create_signal('friendstream', ['UserStream'])


    def backwards(self, orm):
        
        # Deleting model 'Account'
        db.delete_table('friendstream_account')

        # Deleting model 'Video'
        db.delete_table('friendstream_video')

        # Deleting model 'UserStream'
        db.delete_table('friendstream_userstream')
