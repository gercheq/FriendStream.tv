...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.embed_code'
        db.delete_column('friendstream_video', 'embed_code')

        # Deleting field 'Video.height'
        db.delete_column('friendstream_video', 'height')

        # Deleting field 'Video.width'
        db.delete_column('friendstream_video', 'width')

        # Adding field 'Video.data'
        db.add_column('friendstream_video', 'data', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Video.embed_code'
        db.add_column('friendstream_video', 'embed_code', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Video.height'
        db.add_column('friendstream_video', 'height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Video.width'
        db.add_column('friendstream_video', 'width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Video.data'
        db.delete_column('friendstream_video', 'data')
