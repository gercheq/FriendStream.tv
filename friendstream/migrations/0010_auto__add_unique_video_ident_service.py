...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Video', fields ['ident', 'service']
        db.create_unique('friendstream_video', ['ident', 'service'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Video', fields ['ident', 'service']
        db.delete_unique('friendstream_video', ['ident', 'service'])
