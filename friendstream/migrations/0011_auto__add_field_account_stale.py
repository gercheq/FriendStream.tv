...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.stale'
        db.add_column('friendstream_account', 'stale', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.stale'
        db.delete_column('friendstream_account', 'stale')
