...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserStream.message_service'
        db.add_column('friendstream_userstream', 'message_service', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'UserStream.message_ident'
        db.add_column('friendstream_userstream', 'message_ident', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserStream.message_service'
        db.delete_column('friendstream_userstream', 'message_service')

        # Deleting field 'UserStream.message_ident'
        db.delete_column('friendstream_userstream', 'message_ident')
    ...
    models = {
        ...
        'friendstream.userstream': {
            ...
            'message_ident': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'message_service': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        'friendstream.video': {
            'Meta': {'unique_together': "(('service', 'ident'),)", 'object_name': 'Video'},
